...
> สถานะ: **Phase 4 เสร็จครบ (Settings/Print/Design)**; ถัดไป Phase 5 (print window — ทำไปแล้วบางส่วนใน 4b) · Phase 6 (cutover/exe) — branch `feat/vite-migration`; main = แอป dc เดิมใช้งานปกติ
